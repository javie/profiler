...
(function() {
  var Profiler, ProfilerRepository, enabled, instances, microtime, root, schema, underscore;
  ...
  if (!(underscore && (typeof require !== "undefined" && require !== null))) {
    underscore = require('underscore');
  }

  if (!underscore) {
    throw new Error("Underscore.js is not available");
  }
  ...
  Profiler = (function() {
    ...
    Profiler.prototype.startedAt = null;
    ...
    Profiler.prototype.timeEnd = function(id, message) {
      ...
      if (typeof key !== 'undefined') {
        ...
        log = schema('time', id, this.startAt);
